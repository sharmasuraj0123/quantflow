...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center cursor-pointer" onClick={() => scrollToSection("hero")}>
              <div className="relative w-10 h-10 flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-blue-800 to-slate-700 rounded-xl shadow-lg transform rotate-12"></div>
                <div className="absolute inset-1 bg-gradient-to-tr from-slate-200 to-white rounded-lg shadow-inner"></div>
                <div className="relative z-10 w-6 h-6 flex items-center justify-center">
                  <div className="text-blue-900 font-bold text-lg leading-none">Q</div>
                  <div className="absolute -right-1 top-1 w-2 h-0.5 bg-gradient-to-r from-blue-900 to-transparent rounded-full"></div>
                  <div className="absolute -right-0.5 top-2 w-1.5 h-0.5 bg-gradient-to-r from-blue-800 to-transparent rounded-full"></div>
                </div>
              </div>
              <span className="ml-3 text-xl font-semibold text-gray-900">QuantaFlow</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button variant="outline" className="border-slate-300 text-blue-800 hover:bg-slate-50 bg-transparent">
                Login
              </Button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden border-t border-gray-100 py-4 space-y-4">
              ...
              <div className="px-4">
                <Button
                  variant="outline"
                  className="w-full border-slate-300 text-blue-800 hover:bg-slate-50 bg-transparent"
                >
                  Login
                </Button>
              </div>
      ...
      {/* Hero Section */}
      <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-slate-50">
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-slate-100 rounded-full opacity-20 animate-pulse"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              <Badge className="mb-3 bg-slate-100 text-slate-800 hover:bg-slate-200 text-xs">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-6">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-950 text-white px-6 py-3 text-base font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 group"
                  onClick={() => scrollToSection("pricing")}
                >
                  Start Free Trial
                ...
                <div className="flex items-center">
                  <div className="flex -space-x-1">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-800 to-blue-500 border-2 border-white"
                      ></div>
                    ))}
                  </div>
              ...
              <div className="relative bg-white rounded-xl shadow-xl p-4 border border-gray-100">
                ...
                <div className="mb-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <div className="h-16 bg-gradient-to-r from-slate-50 to-blue-50 rounded flex items-end justify-between p-2">
                      {[65, 78, 82, 88, 95, 92, 98].map((height, index) => (
                        <div
                          key={index}
                          className="bg-gradient-to-t from-blue-900 to-blue-800 rounded-t transition-all duration-500"
                          style={{
                            height: `${height * 0.6}%`,
                            width: "10%",
                          }}
                  ...
                  {/* Compact AI Insights */}
                  <div className="mt-3 p-3 bg-gradient-to-r from-slate-50 to-blue-50 rounded-lg">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-900 to-blue-600 rounded-lg">
                  ...
                  <p className="text-slate-100 mb-4">Start your free trial and experience the power of QuantaFlow</p>
                  <Button
                    onClick={() => scrollToSection("pricing")}
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-slate-100 to-slate-200 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                ...
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-blue-900 mr-2" />
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="border-2 border-gray-200 hover:border-teal-300 transition-colors">
              <CardContent className="p-8">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-blue-900 mr-3" />
                    Up to 100K records/month
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-blue-900 mr-3" />5 team members
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-blue-900 mr-3" />
                    Basic analytics
            ...
            <Card className="border-2 border-teal-500 relative shadow-lg">
              ...
              <CardContent className="p-8">
                ...
                <Button className="w-full bg-blue-900 hover:bg-blue-800">Start Free Trial</Button>
              </CardContent>
            </Card>
            ...
            {[
              ...
              <Card key={index} className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-800 to-blue-500 rounded-full flex items-center justify-center text-white font-semibold mr-4">
                      {testimonial.name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")}
          ...
          <Card className="border-0 shadow-xl">
            <CardContent className="p-8">
              <form onSubmit={handleEmailSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-950 text-white py-3 text-lg font-semibold"
